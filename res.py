...
for i, keyword in enumerate(keywords):
    ...
    for page in range(0, max_pages):
        url = f'https://hh.kz/search/resume?text={keyword}&area=160&currency_code=KZT&ored_clusters=true&order_by=relevance&search_period=0&logic=normal&pos=full_text&exp_period=all_time&page={page}'
